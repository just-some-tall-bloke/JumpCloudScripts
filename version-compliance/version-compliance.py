...
"""
macOS Version Compliance Script
- Adds systems running below a specified macOS version to a device group
- Removes systems that have upgraded and are now compliant
